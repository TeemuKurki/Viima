...
var url = 'http://api.steampowered.com/ISteamUserStats/GetSchemaForGame/' +
    'v2/?key=F3EDBB435D4790748AD1D99F4DDCE69C&appid=8930';
...
app.get('/steam/lassi', function(httpRequest, httpResponse) {
    // Calculate the Steam API URL we want to use
    var url = 'http://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/?key=F3EDBB435D4790748AD1D99F4DDCE69C&steamid=76561198031553385&include_appinfo=name&format=json';
    request.get(url, function(error, steamHttpResponse, steamHttpBody) {
...
app.get('/steam/game/:appid/achievements', function(httpRequest, httpResponse) {
    // Calculate the Steam API URL we want to use
    var url = 'http://api.steampowered.com/ISteamUserStats/GetSchemaForGame/' +
        'v2/?key=F3EDBB435D4790748AD1D99F4DDCE69C&appid=' +
